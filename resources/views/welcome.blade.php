...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/store-product">Add Product Standar</router-link>
   <router-link class="collapse-item" to="/store-productpk">Add Product Paket</router-link>
